...
class unit_complejos(unittest.TestCase):
    ...
    def test_polar(self):
        self.assertEqual(Complejos.polar([-3, -1]), (3.1622776601683795, 0.3217505543966422))
        self.assertEqual(Complejos.polar([1, 1]), (1.4142135623730951, 0.7853981633974483))

    #Pruebas para la conversión de representación polar a cartesiana.
    def test_polarc(self):
        self.assertEqual(Complejos.polarc([3, math.pi/3]), (1.5000000000000004, 2.598076211353316))
        self.assertEqual(Complejos.polarc([4, math.pi/6]), (3.464101615137755, 1.9999999999999998))
